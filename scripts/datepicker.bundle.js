/*! datepicker.bundle.js v2.45.0 by Vaudoise Assurances © 22.04.2021 11:37:18 - hash:b3fcbb35d2a0982718be */
...
/* harmony import */ var _types_options__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./types/options */ "./node_modules/flatpickr/dist/esm/types/options.js");
/* harmony import */ var _l10n_default__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./l10n/default */ "./node_modules/flatpickr/dist/esm/l10n/default.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./utils */ "./node_modules/flatpickr/dist/esm/utils/index.js");
/* harmony import */ var _utils_dom__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./utils/dom */ "./node_modules/flatpickr/dist/esm/utils/dom.js");
/* harmony import */ var _utils_dates__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./utils/dates */ "./node_modules/flatpickr/dist/esm/utils/dates.js");
/* harmony import */ var _utils_formatting__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./utils/formatting */ "./node_modules/flatpickr/dist/esm/utils/formatting.js");
/* harmony import */ var _utils_polyfills__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./utils/polyfills */ "./node_modules/flatpickr/dist/esm/utils/polyfills.js");
...
function FlatpickrInstance(element, instanceConfig) {
  var self = {
    config: Object.assign(Object.assign({}, _types_options__WEBPACK_IMPORTED_MODULE_22__["defaults"]), flatpickr.defaultConfig),
    l10n: _l10n_default__WEBPACK_IMPORTED_MODULE_23__["default"]
  };
  self.parseDate = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["createDateParser"])({
    config: self.config,
    l10n: self.l10n
  });
  self._handlers = [];
  ...
  self.clear = clear;
  self.close = close;
  self._createElement = _utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"];
  ...
  function updateTime(e) {
    if (self.selectedDates.length === 0) {
      var defaultDate = self.config.minDate === undefined || Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(new Date(), self.config.minDate) >= 0 ? new Date() : new Date(self.config.minDate.getTime());
      var defaults = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["getDefaultHours"])(self.config);
  ...
  function ampm2military(hour, amPM) {
    return hour % 12 + 12 * Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(amPM === self.l10n.amPM[1]);
  }
  ...
  function setHoursFromInputs() {
    ...
    var limitMinHours = self.config.minTime !== undefined || self.config.minDate && self.minDateHasTime && self.latestSelectedDateObj && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(self.latestSelectedDateObj, self.config.minDate, true) === 0;
    var limitMaxHours = self.config.maxTime !== undefined || self.config.maxDate && self.maxDateHasTime && self.latestSelectedDateObj && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(self.latestSelectedDateObj, self.config.maxDate, true) === 0;
  ...
  function setHours(hours, minutes, seconds) {
    ...
    self.hourElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(!self.config.time_24hr ? (12 + hours) % 12 + 12 * Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(hours % 12 === 0) : hours);
    self.minuteElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(minutes);
    if (self.amPM !== undefined) self.amPM.textContent = self.l10n.amPM[Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(hours >= 12)];
    if (self.secondElement !== undefined) self.secondElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(seconds);
  }

  function onYearInput(event) {
    var eventTarget = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(event);
  ...
  function bindEvents() {
    ...
    var debouncedResize = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["debounce"])(onResize, 50);
    self._debouncedChange = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["debounce"])(triggerChange, DEBOUNCED_CHANGE_MS);
    if (self.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent)) bind(self.daysContainer, "mouseover", function (e) {
      if (self.config.mode === "range") onMouseOver(Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e));
    });
    ...
    if (self.timeContainer !== undefined && self.minuteElement !== undefined && self.hourElement !== undefined) {
      var selText = function selText(e) {
        return Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e).select();
      };
  ...
  function timeIncrement(e) {
    var eventTarget = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e);
    if (~eventTarget.className.indexOf("arrow")) incrementNumInput(e, eventTarget.classList.contains("arrowUp") ? 1 : -1);
  }

  function incrementNumInput(e, delta, inputElem) {
    var target = e && Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e);
  ...
  function build() {
    ...
    self.calendarContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-calendar");
    self.calendarContainer.tabIndex = -1;

    if (!self.config.noCalendar) {
      fragment.appendChild(buildMonthNav());
      self.innerContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-innerContainer");
      ...
      self.rContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-rContainer");
      self.rContainer.appendChild(buildWeekdays());

      if (!self.daysContainer) {
        self.daysContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-days");
    ...
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "rangeMode", self.config.mode === "range");
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "animate", self.config.animate === true);
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "multiMonth", self.config.showMonths > 1);
    ...
    if (self.config.inline || self.config.static) {
      ...
      if (self.config.static) {
        var wrapper = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-wrapper");
  ...
  function createDay(className, date, dayNumber, i) {
    var dateIsEnabled = isEnabled(date, true),
        dayElement = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-day " + className, date.getDate().toString());
    dayElement.dateObj = date;
    dayElement.$i = i;
    dayElement.setAttribute("aria-label", self.formatDate(date, self.config.ariaDateFormat));

    if (className.indexOf("hidden") === -1 && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(date, self.now) === 0) {
    ...
    if (dateIsEnabled) {
      ...
      if (isDateSelected(date)) {
        ...
        if (self.config.mode === "range") {
          Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(dayElement, "startRange", self.selectedDates[0] && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(date, self.selectedDates[0], true) === 0);
          Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(dayElement, "endRange", self.selectedDates[1] && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(date, self.selectedDates[1], true) === 0);
  ...
  function buildMonthDays(year, month) {
    ...
    var dayContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "dayContainer");
  ...
  function buildDays() {
    ...
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["clearNode"])(self.daysContainer);
    if (self.weekNumbers) Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["clearNode"])(self.weekNumbers);
  ...
  function buildMonthSwitch() {
    ...
    for (var i = 0; i < 12; i++) {
      ...
      var month = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("option", "flatpickr-monthDropdown-month");
      month.value = new Date(self.currentYear, i).getMonth().toString();
      month.textContent = Object(_utils_formatting__WEBPACK_IMPORTED_MODULE_27__["monthToStr"])(i, self.config.shorthandCurrentMonth, self.l10n);
      month.tabIndex = -1;
  ...
  function buildMonth() {
    var container = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-month");
    var monthNavFragment = window.document.createDocumentFragment();
    var monthElement;

    if (self.config.showMonths > 1 || self.config.monthSelectorType === "static") {
      monthElement = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "cur-month");
    } else {
      self.monthsDropdownContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("select", "flatpickr-monthDropdown-months");
      self.monthsDropdownContainer.setAttribute("aria-label", self.l10n.monthAriaLabel);
      bind(self.monthsDropdownContainer, "change", function (e) {
        var target = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e);
    ...
    var yearInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createNumberInput"])("cur-year", {
      tabindex: "-1"
    });
    ...
    var currentMonth = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-current-month");
  ...
  function buildMonths() {
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["clearNode"])(self.monthNav);
  ...
  function buildMonthNav() {
    self.monthNav = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-months");
    self.yearElements = [];
    self.monthElements = [];
    self.prevMonthNav = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-prev-month");
    self.prevMonthNav.innerHTML = self.config.prevArrow;
    self.nextMonthNav = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-next-month");
    ...
    Object.defineProperty(self, "_hidePrevMonthArrow", {
      ...
      set: function set(bool) {
        if (self.__hidePrevMonthArrow !== bool) {
          Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.prevMonthNav, "flatpickr-disabled", bool);
    ...
    Object.defineProperty(self, "_hideNextMonthArrow", {
      ...
      set: function set(bool) {
        if (self.__hideNextMonthArrow !== bool) {
          Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.nextMonthNav, "flatpickr-disabled", bool);
  ...
  function buildTime() {
    ...
    var defaults = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["getDefaultHours"])(self.config);
    self.timeContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-time");
    self.timeContainer.tabIndex = -1;
    var separator = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-time-separator", ":");
    var hourInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createNumberInput"])("flatpickr-hour", {
      "aria-label": self.l10n.hourAriaLabel
    });
    self.hourElement = hourInput.getElementsByTagName("input")[0];
    var minuteInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createNumberInput"])("flatpickr-minute", {
      "aria-label": self.l10n.minuteAriaLabel
    });
    self.minuteElement = minuteInput.getElementsByTagName("input")[0];
    self.hourElement.tabIndex = self.minuteElement.tabIndex = -1;
    self.hourElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(self.latestSelectedDateObj ? self.latestSelectedDateObj.getHours() : self.config.time_24hr ? defaults.hours : military2ampm(defaults.hours));
    self.minuteElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(self.latestSelectedDateObj ? self.latestSelectedDateObj.getMinutes() : defaults.minutes);
    ...
    if (self.config.enableSeconds) {
      ...
      var secondInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createNumberInput"])("flatpickr-second");
      self.secondElement = secondInput.getElementsByTagName("input")[0];
      self.secondElement.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(self.latestSelectedDateObj ? self.latestSelectedDateObj.getSeconds() : defaults.seconds);
      self.secondElement.setAttribute("step", self.minuteElement.getAttribute("step"));
      self.secondElement.setAttribute("min", "0");
      self.secondElement.setAttribute("max", "59");
      self.secondElement.setAttribute("maxlength", "2");
      self.timeContainer.appendChild(Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-time-separator", ":"));
      self.timeContainer.appendChild(secondInput);
    }

    if (!self.config.time_24hr) {
      self.amPM = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-am-pm", self.l10n.amPM[Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])((self.latestSelectedDateObj ? self.hourElement.value : self.config.defaultHour) > 11)]);
  ...
  function buildWeekdays() {
    if (!self.weekdayContainer) self.weekdayContainer = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-weekdays");else Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["clearNode"])(self.weekdayContainer);

    for (var i = self.config.showMonths; i--;) {
      var container = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-weekdaycontainer");
  ...
  function updateWeekdays() {
    ...
    var weekdays = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(self.l10n.weekdays.shorthand);

    if (firstDayOfWeek > 0 && firstDayOfWeek < weekdays.length) {
      weekdays = [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(weekdays.splice(firstDayOfWeek, weekdays.length)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(weekdays.splice(0, firstDayOfWeek)));
    }
  ...
  function buildWeeks() {
    ...
    var weekWrapper = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-weekwrapper");
    weekWrapper.appendChild(Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("span", "flatpickr-weekday", self.l10n.weekAbbreviation));
    var weekNumbers = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("div", "flatpickr-weeks");
  ...
  function clear() {
    ...
    if (self.config.enableTime === true) {
      var _getDefaultHours = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["getDefaultHours"])(self.config),
  ...
  function isEnabled(date) {
    ...
    if (self.config.minDate && dateToCheck && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(dateToCheck, self.config.minDate, timeless !== undefined ? timeless : !self.minDateHasTime) < 0 || self.config.maxDate && dateToCheck && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(dateToCheck, self.config.maxDate, timeless !== undefined ? timeless : !self.maxDateHasTime) > 0) return false;
    ...
    for (var i = 0, d; i < array.length; i++) {
      ...
      } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(d) === "object" && dateToCheck !== undefined && d.from && d.to && dateToCheck.getTime() >= d.from.getTime() && dateToCheck.getTime() <= d.to.getTime()) return bool;
    }
  ...
  function onMouseOver(elem) {
    ...
    for (var t = rangeStartDate; t < rangeEndDate; t += _utils_dates__WEBPACK_IMPORTED_MODULE_26__["duration"].DAY) {
    ...
    for (var m = 0; m < self.config.showMonths; m++) {
      ...
      var _loop = function _loop(i, l) {
        ...
        if (elem !== undefined) {
          ...
          if (timestamp >= minRange && (maxRange === 0 || timestamp <= maxRange) && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["isBetween"])(timestamp, initialDate, hoverDate)) dayElem.classList.add("inRange");
        }
      };
  ...
  function parseConfig() {
    ...
    if (!userConfig.dateFormat && (userConfig.enableTime || timeMode)) {
      var defaultDateFormat = flatpickr.defaultConfig.dateFormat || _types_options__WEBPACK_IMPORTED_MODULE_22__["defaults"].dateFormat;
      formats.dateFormat = userConfig.noCalendar || timeMode ? "H:i" + (userConfig.enableSeconds ? ":S" : "") : defaultDateFormat + " H:i" + (userConfig.enableSeconds ? ":S" : "");
    }

    if (userConfig.altInput && (userConfig.enableTime || timeMode) && !userConfig.altFormat) {
      var defaultAltFormat = flatpickr.defaultConfig.altFormat || _types_options__WEBPACK_IMPORTED_MODULE_22__["defaults"].altFormat;
    ...
    _types_options__WEBPACK_IMPORTED_MODULE_22__["HOOKS"].filter(function (hook) {
      return self.config[hook] !== undefined;
    }).forEach(function (hook) {
      self.config[hook] = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["arrayify"])(self.config[hook] || []).map(bindToInstance);
    });
    ...
    for (var _i = 0; _i < self.config.plugins.length; _i++) {
      ...
      for (var key in pluginConf) {
        if (_types_options__WEBPACK_IMPORTED_MODULE_22__["HOOKS"].indexOf(key) > -1) {
          self.config[key] = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["arrayify"])(pluginConf[key]).map(bindToInstance).concat(self.config[key]);
  ...
  function setupLocale() {
    if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(self.config.locale) !== "object" && typeof flatpickr.l10ns[self.config.locale] === "undefined") self.config.errorHandler(new Error("flatpickr: invalid locale ".concat(self.config.locale)));
    self.l10n = Object.assign(Object.assign({}, flatpickr.l10ns.default), _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(self.config.locale) === "object" ? self.config.locale : self.config.locale !== "default" ? flatpickr.l10ns[self.config.locale] : undefined);
    _utils_formatting__WEBPACK_IMPORTED_MODULE_27__["tokenRegex"].K = "(".concat(self.l10n.amPM[0], "|").concat(self.l10n.amPM[1], "|").concat(self.l10n.amPM[0].toLowerCase(), "|").concat(self.l10n.amPM[1].toLowerCase(), ")");
    ...
    self.formatDate = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["createDateFormatter"])(self);
    self.parseDate = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["createDateParser"])({
      config: self.config,
      l10n: self.l10n
    });
  ...
  function positionCalendar(customPositionElement) {
    ...
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "arrowTop", !showOnTop);
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "arrowBottom", showOnTop);
    ...
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "arrowLeft", !isCenter && !isRight);
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "arrowCenter", isCenter);
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "arrowRight", isRight);
    var right = window.document.body.offsetWidth - (window.pageXOffset + inputBounds.right);
    var rightMost = left + calendarWidth > window.document.body.offsetWidth;
    var centerMost = right + calendarWidth > window.document.body.offsetWidth;
    Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "rightMost", rightMost);
    ...
    if (!rightMost) {
      ...
      Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "rightMost", false);
      Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["toggleClass"])(self.calendarContainer, "centerMost", true);
  ...
  function selectDate(e) {
    ...
    var t = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["findParent"])(Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e), isSelectable);
    ...
    if (self.config.mode === "single") self.selectedDates = [selectedDate];else if (self.config.mode === "multiple") {
      ...
      if (Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(selectedDate, self.selectedDates[0], true) !== 0) self.selectedDates.sort(function (a, b) {
  ...
  function set(option, value) {
    if (option !== null && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(option) === "object") {
      ...
      if (CALLBACKS[option] !== undefined) CALLBACKS[option].forEach(function (x) {
        return x();
      });else if (_types_options__WEBPACK_IMPORTED_MODULE_22__["HOOKS"].indexOf(option) > -1) self.config[option] = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["arrayify"])(value);
    }
  ...
  function parseDateRules(arr) {
    return arr.slice().map(function (rule) {
      ...
      } else if (rule && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(rule) === "object" && rule.from && rule.to) return {
  ...
  function setupInputs() {
    ...
    if (self.config.altInput) {
      self.altInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])(self.input.nodeName, self.config.altInputClass);
  ...
  function setupMobile() {
    ...
    self.mobileInput = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["createElement"])("input", self.input.className + " flatpickr-mobile");
    ...
    bind(self.mobileInput, "change", function (e) {
      self.setDate(Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e).value, false, self.mobileFormatStr);
      triggerEvent("onChange");
      triggerEvent("onClose");
    });
  }
  ...
  function isDateSelected(date) {
    for (var i = 0; i < self.selectedDates.length; i++) {
      if (Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(self.selectedDates[i], date) === 0) return "" + i;
    }
  ...
  function isDateInRange(date) {
    ...
    return Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(date, self.selectedDates[0]) >= 0 && Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"])(date, self.selectedDates[1]) <= 0;
  }
  ...
  function updateNavigationCurrentMonth() {
    ...
    self.yearElements.forEach(function (yearElement, i) {
      ...
      if (self.config.showMonths > 1 || self.config.monthSelectorType === "static") {
        self.monthElements[i].textContent = Object(_utils_formatting__WEBPACK_IMPORTED_MODULE_27__["monthToStr"])(d.getMonth(), self.config.shorthandCurrentMonth, self.l10n) + " ";
      } else {
  ...
  function timeWrapper(e) {
    ...
    var isKeyDown = e.type === "keydown",
        eventTarget = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_25__["getEventTarget"])(e),
        input = eventTarget;

    if (self.amPM !== undefined && eventTarget === self.amPM) {
      self.amPM.textContent = self.l10n.amPM[Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(self.amPM.textContent === self.l10n.amPM[0])];
    }
    ...
    if (typeof input.value !== "undefined" && input.value.length === 2) {
      ...
      if (newValue < min) {
        newValue = max + newValue + Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(!isHourElem) + (Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(isHourElem) && Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(!self.amPM));
        if (isMinuteElem) incrementNumInput(undefined, -1, self.hourElement);
      } else if (newValue > max) {
        newValue = input === self.hourElement ? newValue - max - Object(_utils__WEBPACK_IMPORTED_MODULE_24__["int"])(!self.amPM) : min;
        if (isMinuteElem) incrementNumInput(undefined, 1, self.hourElement);
      }
      ...
      input.value = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["pad"])(newValue);
    }
  }
...
flatpickr.l10ns = {
  en: Object.assign({}, _l10n_default__WEBPACK_IMPORTED_MODULE_23__["default"]),
  default: Object.assign({}, _l10n_default__WEBPACK_IMPORTED_MODULE_23__["default"])
};
...
flatpickr.parseDate = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["createDateParser"])({});
flatpickr.formatDate = Object(_utils_dates__WEBPACK_IMPORTED_MODULE_26__["createDateFormatter"])({});
flatpickr.compareDates = _utils_dates__WEBPACK_IMPORTED_MODULE_26__["compareDates"];
...
var defaults = {
  ...
  animate: (typeof window === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(window)) === "object" && window.navigator.userAgent.indexOf("MSIE") === -1,
...
/* harmony import */ var _formatting__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./formatting */ "./node_modules/flatpickr/dist/esm/utils/formatting.js");
/* harmony import */ var _types_options__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../types/options */ "./node_modules/flatpickr/dist/esm/types/options.js");
/* harmony import */ var _l10n_default__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../l10n/default */ "./node_modules/flatpickr/dist/esm/l10n/default.js");
...
var createDateFormatter = function createDateFormatter(_ref) {
  var _ref$config = _ref.config,
      config = _ref$config === void 0 ? _types_options__WEBPACK_IMPORTED_MODULE_10__["defaults"] : _ref$config,
      _ref$l10n = _ref.l10n,
      l10n = _ref$l10n === void 0 ? _l10n_default__WEBPACK_IMPORTED_MODULE_11__["english"] : _ref$l10n,
  ...
  return function (dateObj, frmt, overrideLocale) {
    ...
    return frmt.split("").map(function (c, i, arr) {
      return _formatting__WEBPACK_IMPORTED_MODULE_9__["formats"][c] && arr[i - 1] !== "\\" ? _formatting__WEBPACK_IMPORTED_MODULE_9__["formats"][c](dateObj, locale, config) : c !== "\\" ? c : "";
    }).join("");
  };
};
var createDateParser = function createDateParser(_ref2) {
  var _ref2$config = _ref2.config,
      config = _ref2$config === void 0 ? _types_options__WEBPACK_IMPORTED_MODULE_10__["defaults"] : _ref2$config,
      _ref2$l10n = _ref2.l10n,
      l10n = _ref2$l10n === void 0 ? _l10n_default__WEBPACK_IMPORTED_MODULE_11__["english"] : _ref2$l10n;
  return function (date, givenFormat, timeless, customLocale) {
    ...
    if (date instanceof Date) parsedDate = new Date(date.getTime());else if (typeof date !== "string" && date.toFixed !== undefined) parsedDate = new Date(date);else if (typeof date === "string") {
      var format = givenFormat || (config || _types_options__WEBPACK_IMPORTED_MODULE_10__["defaults"]).dateFormat;
      ...
      if (datestr === "today") {
        ...
        for (var i = 0, matchIndex = 0, regexStr = ""; i < format.length; i++) {
          ...
          if (_formatting__WEBPACK_IMPORTED_MODULE_9__["tokenRegex"][token] && !escaped) {
            regexStr += _formatting__WEBPACK_IMPORTED_MODULE_9__["tokenRegex"][token];
            var match = new RegExp(regexStr).exec(date);

            if (match && (matched = true)) {
              ops[token !== "Y" ? "push" : "unshift"]({
                fn: _formatting__WEBPACK_IMPORTED_MODULE_9__["revFormat"][token],
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils */ "./node_modules/flatpickr/dist/esm/utils/index.js");
...
var revFormat = {
  ...
  K: function K(dateObj, amPM, locale) {
    dateObj.setHours(dateObj.getHours() % 12 + 12 * Object(_utils__WEBPACK_IMPORTED_MODULE_7__["int"])(new RegExp(locale.amPM[1], "i").test(amPM)));
  },
...
var formats = {
  ...
  G: function G(date, locale, options) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(formats.h(date, locale, options));
  },
  H: function H(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getHours());
  },
  J: function J(date, locale) {
    return locale.ordinal !== undefined ? date.getDate() + locale.ordinal(date.getDate()) : date.getDate();
  },
  K: function K(date, locale) {
    return locale.amPM[Object(_utils__WEBPACK_IMPORTED_MODULE_7__["int"])(date.getHours() > 11)];
  },
  M: function M(date, locale) {
    return monthToStr(date.getMonth(), true, locale);
  },
  S: function S(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getSeconds());
  },
  U: function U(date) {
  ...
  Y: function Y(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getFullYear(), 4);
  },
  d: function d(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getDate());
  },
  h: function h(date) {
    return date.getHours() % 12 ? date.getHours() % 12 : 12;
  },
  i: function i(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getMinutes());
  },
  j: function j(date) {
    return date.getDate();
  },
  ...
  m: function m(date) {
    return Object(_utils__WEBPACK_IMPORTED_MODULE_7__["pad"])(date.getMonth() + 1);
  },
  n: function n(date) {
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.de = {}));
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fr = {}));
})(undefined, function (exports) {
  'use strict';
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.it = {}));
})(undefined, function (exports) {
  'use strict';
...
var UpdatingElement = /*#__PURE__*/function (_HTMLElement) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(UpdatingElement, _HTMLElement);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(UpdatingElement, [{
    ...
    key: "_enqueueUpdate",
    value: function () {
      var _enqueueUpdate2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee() {
        var result;
...
/* harmony import */ var lit_html_lib_shady_render_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lit-html/lib/shady-render.js */ "./node_modules/lit-html/lib/shady-render.js");
/* harmony import */ var _lib_updating_element_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/updating-element.js */ "./node_modules/lit-element/lib/updating-element.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultConverter", function() { return _lib_updating_element_js__WEBPACK_IMPORTED_MODULE_7__["defaultConverter"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "notEqual", function() { return _lib_updating_element_js__WEBPACK_IMPORTED_MODULE_7__["notEqual"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UpdatingElement", function() { return _lib_updating_element_js__WEBPACK_IMPORTED_MODULE_7__["UpdatingElement"]; });

/* harmony import */ var _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/decorators.js */ "./node_modules/lit-element/lib/decorators.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "customElement", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["customElement"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "property", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["property"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "internalProperty", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["internalProperty"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "query", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["query"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "queryAsync", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["queryAsync"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "queryAll", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["queryAll"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "eventOptions", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["eventOptions"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "queryAssignedNodes", function() { return _lib_decorators_js__WEBPACK_IMPORTED_MODULE_8__["queryAssignedNodes"]; });

/* harmony import */ var lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! lit-html/lit-html.js */ "./node_modules/lit-html/lit-html.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "html", function() { return lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_9__["html"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "svg", function() { return lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_9__["svg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TemplateResult", function() { return lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_9__["TemplateResult"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SVGTemplateResult", function() { return lit_html_lit_html_js__WEBPACK_IMPORTED_MODULE_9__["SVGTemplateResult"]; });
...
var LitElement = /*#__PURE__*/function (_UpdatingElement) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(LitElement, _UpdatingElement);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(LitElement, [{
     ...
     */
    function initialize() {
      _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(LitElement.prototype), "initialize", this).call(this);
    ...
    key: "connectedCallback",
    value: function connectedCallback() {
      _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(LitElement.prototype), "connectedCallback", this).call(this); // Note, first update/render handles styleElement so we only call this if
    ...
    value: function update(changedProperties) {
      ...
      _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(LitElement.prototype), "update", this).call(this, changedProperties); // If render is not implemented by the component, don't call lit-html render
    ...
    value: function _getUniqueStyles() {
      ...
      this._styles = this._styles.map(function (s) {
        if (s instanceof CSSStyleSheet && !_lib_css_tag_js__WEBPACK_IMPORTED_MODULE_10__["supportsAdoptingStyleSheets"]) {
          ...
          return Object(_lib_css_tag_js__WEBPACK_IMPORTED_MODULE_10__["unsafeCSS"])(cssText);
        }
  ...
  return LitElement;
}(_lib_updating_element_js__WEBPACK_IMPORTED_MODULE_7__["UpdatingElement"]);
/**
...
LitElement.render = lit_html_lib_shady_render_js__WEBPACK_IMPORTED_MODULE_6__["render"];
...
/***/ "./webcomponents/va-datepicker/va-datepicker.config.ts":
/*!*************************************************************!*\
  !*** ./webcomponents/va-datepicker/va-datepicker.config.ts ***!
  \*************************************************************/
...
var config = {
  ...
  /**
   * The format used to be displayed to the user
   */
  altFormat: 'd.m.Y',

  /**
   * The format used to be used programmatically (ex: server request)
   */
  dateFormat: 'Y-m-d'
};
...
/***/ "./webcomponents/va-datepicker/va-datepicker.styl":
/*!********************************************************!*\
  !*** ./webcomponents/va-datepicker/va-datepicker.styl ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = ".flatpickr-calendar{background:transparent;opacity:0;display:none;text-align:center;visibility:hidden;padding:0;animation:none;direction:ltr;border:0;font-size:14px;line-height:24px;border-radius:5px;position:absolute;width:307.875px;box-sizing:border-box;touch-action:manipulation;box-shadow:0 3px 13px rgba(0,0,0,.08)}.flatpickr-calendar.inline,.flatpickr-calendar.open{opacity:1;max-height:640px;visibility:visible}.flatpickr-calendar.open{display:inline-block;z-index:99999}.flatpickr-calendar.animate.open{animation:fpFadeInDown .3s cubic-bezier(.23,1,.32,1)}.flatpickr-calendar.inline{display:block;position:relative;top:2px}.flatpickr-calendar.static{position:absolute;top:calc(100% + 2px)}.flatpickr-calendar.static.open{z-index:999;display:block}.flatpickr-calendar.multiMonth .flatpickr-days .dayContainer:nth-child(n+1) .flatpickr-day.inRange:nth-child(7n+7){box-shadow:none!important}.flatpickr-calendar.multiMonth .flatpickr-days .dayContainer:nth-child(n+2) .flatpickr-day.inRange:nth-child(7n+1){box-shadow:-2px 0 0 #e6e6e6,5px 0 0 #e6e6e6}.flatpickr-calendar .hasTime .dayContainer,.flatpickr-calendar .hasWeeks .dayContainer{border-bottom:0;border-bottom-right-radius:0;border-bottom-left-radius:0}.flatpickr-calendar .hasWeeks .dayContainer{border-left:0}.flatpickr-calendar.hasTime .flatpickr-time{height:40px;border-top:1px solid rgba(88,88,88,.2)}.flatpickr-calendar.hasTime .flatpickr-innerContainer{border-bottom:0}.flatpickr-calendar.hasTime .flatpickr-time{border:1px solid rgba(88,88,88,.2)}.flatpickr-calendar.noCalendar.hasTime .flatpickr-time{height:auto}.flatpickr-calendar:after,.flatpickr-calendar:before{position:absolute;display:block;pointer-events:none;border:solid transparent;content:\"\";height:0;width:0;left:22px}.flatpickr-calendar.arrowRight:after,.flatpickr-calendar.arrowRight:before,.flatpickr-calendar.rightMost:after,.flatpickr-calendar.rightMost:before{left:auto;right:22px}.flatpickr-calendar.arrowCenter:after,.flatpickr-calendar.arrowCenter:before{left:50%;right:50%}.flatpickr-calendar:before{border-width:5px;margin:0 -5px}.flatpickr-calendar:after{border-width:4px;margin:0 -4px}.flatpickr-calendar.arrowTop:after,.flatpickr-calendar.arrowTop:before{bottom:100%}.flatpickr-calendar.arrowTop:before{border-bottom-color:rgba(88,88,88,.2)}.flatpickr-calendar.arrowTop:after{border-bottom-color:#009640}.flatpickr-calendar.arrowBottom:after,.flatpickr-calendar.arrowBottom:before{top:100%}.flatpickr-calendar.arrowBottom:before{border-top-color:rgba(88,88,88,.2)}.flatpickr-calendar.arrowBottom:after{border-top-color:#009640}.flatpickr-calendar:focus{outline:0}.flatpickr-wrapper{position:relative;display:inline-block}.flatpickr-months{display:flex}.flatpickr-months .flatpickr-month{border-radius:5px 5px 0 0;background:#009640;color:#fff;fill:#fff;height:34px;line-height:1;text-align:center;position:relative;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;overflow:hidden;flex:1}.flatpickr-months .flatpickr-next-month,.flatpickr-months .flatpickr-prev-month{text-decoration:none;cursor:pointer;position:absolute;top:0;height:34px;padding:10px;z-index:3;color:#fff;fill:#fff}.flatpickr-months .flatpickr-next-month.flatpickr-disabled,.flatpickr-months .flatpickr-prev-month.flatpickr-disabled{display:none}.flatpickr-months .flatpickr-next-month i,.flatpickr-months .flatpickr-prev-month i{position:relative}.flatpickr-months .flatpickr-next-month.flatpickr-prev-month,.flatpickr-months .flatpickr-prev-month.flatpickr-prev-month{left:0}.flatpickr-months .flatpickr-next-month.flatpickr-next-month,.flatpickr-months .flatpickr-prev-month.flatpickr-next-month{right:0}.flatpickr-months .flatpickr-next-month:hover,.flatpickr-months .flatpickr-prev-month:hover{color:#009640}.flatpickr-months .flatpickr-next-month:hover svg,.flatpickr-months .flatpickr-prev-month:hover svg{fill:#f64747}.flatpickr-months .flatpickr-next-month svg,.flatpickr-months .flatpickr-prev-month svg{width:14px;height:14px}.flatpickr-months .flatpickr-next-month svg path,.flatpickr-months .flatpickr-prev-month svg path{transition:fill .1s;fill:inherit}.numInputWrapper{position:relative;height:auto}.numInputWrapper input,.numInputWrapper span{display:inline-block}.numInputWrapper input{width:100%}.numInputWrapper input::-ms-clear{display:none}.numInputWrapper input::-webkit-inner-spin-button,.numInputWrapper input::-webkit-outer-spin-button{margin:0;-webkit-appearance:none}.numInputWrapper span{position:absolute;right:0;width:14px;padding:0 4px 0 2px;height:50%;line-height:50%;opacity:0;cursor:pointer;border:1px solid rgba(88,88,88,.15);box-sizing:border-box}.numInputWrapper span:hover{background:rgba(0,0,0,.1)}.numInputWrapper span:active{background:rgba(0,0,0,.2)}.numInputWrapper span:after{display:block;content:\"\";position:absolute}.numInputWrapper span.arrowUp{top:0;border-bottom:0}.numInputWrapper span.arrowUp:after{border-left:4px solid transparent;border-right:4px solid transparent;border-bottom:4px solid rgba(88,88,88,.6);top:26%}.numInputWrapper span.arrowDown{top:50%}.numInputWrapper span.arrowDown:after{border-left:4px solid transparent;border-right:4px solid transparent;border-top:4px solid rgba(88,88,88,.6);top:40%}.numInputWrapper span svg{width:inherit;height:auto}.numInputWrapper span svg path{fill:hsla(0,0%,100%,.5)}.numInputWrapper:hover{background:rgba(0,0,0,.05)}.numInputWrapper:hover span{opacity:1}.flatpickr-current-month{font-size:135%;line-height:inherit;font-weight:300;color:inherit;position:absolute;width:75%;left:12.5%;padding:7.48px 0 0;line-height:1;height:34px;display:inline-block;text-align:center;transform:translateZ(0)}.flatpickr-current-month span.cur-month{font-family:inherit;font-weight:700;color:inherit;display:inline-block;margin-left:.5ch;padding:0}.flatpickr-current-month span.cur-month:hover{background:rgba(0,0,0,.05)}.flatpickr-current-month .numInputWrapper{width:6ch;width:7ch\\0;display:inline-block}.flatpickr-current-month .numInputWrapper span.arrowUp:after{border-bottom-color:#fff}.flatpickr-current-month .numInputWrapper span.arrowDown:after{border-top-color:#fff}.flatpickr-current-month input.cur-year{background:transparent;box-sizing:border-box;color:inherit;cursor:text;padding:0 0 0 .5ch;margin:0;display:inline-block;font-size:inherit;font-family:inherit;font-weight:300;line-height:inherit;height:auto;border:0;border-radius:0;vertical-align:initial;-webkit-appearance:textfield;-moz-appearance:textfield;appearance:textfield}.flatpickr-current-month input.cur-year:focus{outline:0}.flatpickr-current-month input.cur-year[disabled],.flatpickr-current-month input.cur-year[disabled]:hover{font-size:100%;color:hsla(0,0%,100%,.5);background:transparent;pointer-events:none}.flatpickr-current-month .flatpickr-monthDropdown-months{appearance:menulist;background:#009640;border:none;border-radius:0;box-sizing:border-box;color:inherit;cursor:pointer;font-size:inherit;font-family:inherit;font-weight:300;height:auto;line-height:inherit;margin:-1px 0 0;outline:none;padding:0 0 0 .5ch;position:relative;vertical-align:initial;-webkit-box-sizing:border-box;-webkit-appearance:menulist;-moz-appearance:menulist;width:auto}.flatpickr-current-month .flatpickr-monthDropdown-months:active,.flatpickr-current-month .flatpickr-monthDropdown-months:focus{outline:none}.flatpickr-current-month .flatpickr-monthDropdown-months:hover{background:rgba(0,0,0,.05)}.flatpickr-current-month .flatpickr-monthDropdown-months .flatpickr-monthDropdown-month{background-color:#009640;outline:none;padding:0}.flatpickr-weekdays{background:#009640;text-align:center;overflow:hidden;width:100%;display:flex;align-items:center;height:28px}.flatpickr-weekdays .flatpickr-weekdaycontainer{display:flex;flex:1}span.flatpickr-weekday{cursor:default;font-size:90%;background:#009640;color:#fff;line-height:1;margin:0;text-align:center;display:block;flex:1;font-weight:bolder}.dayContainer,.flatpickr-weeks{padding:1px 0 0}.flatpickr-days{position:relative;overflow:hidden;display:flex;align-items:flex-start;width:307.875px;border-left:1px solid rgba(88,88,88,.2);border-right:1px solid rgba(88,88,88,.2)}.flatpickr-days:focus{outline:0}.dayContainer{padding:0;outline:0;text-align:left;width:307.875px;min-width:307.875px;max-width:307.875px;box-sizing:border-box;display:inline-block;display:flex;flex-wrap:wrap;-ms-flex-wrap:wrap;justify-content:space-around;transform:translateZ(0);opacity:1}.dayContainer+.dayContainer{box-shadow:-1px 0 0 rgba(88,88,88,.2)}.flatpickr-day{background:none;border:1px solid transparent;border-radius:150px;box-sizing:border-box;color:#585858;cursor:pointer;font-weight:400;width:14.2857143%;flex-basis:14.2857143%;max-width:39px;height:39px;line-height:39px;margin:0;display:inline-block;position:relative;justify-content:center;text-align:center}.flatpickr-day.inRange,.flatpickr-day.nextMonthDay.inRange,.flatpickr-day.nextMonthDay.today.inRange,.flatpickr-day.nextMonthDay:focus,.flatpickr-day.nextMonthDay:hover,.flatpickr-day.prevMonthDay.inRange,.flatpickr-day.prevMonthDay.today.inRange,.flatpickr-day.prevMonthDay:focus,.flatpickr-day.prevMonthDay:hover,.flatpickr-day.today.inRange,.flatpickr-day:focus,.flatpickr-day:hover{cursor:pointer;outline:0;background:#d5d5d5;border-color:#d5d5d5}.flatpickr-day.today{border-color:#009640}.flatpickr-day.today:focus,.flatpickr-day.today:hover{border-color:#009640;background:#009640;color:#fff}.flatpickr-day.endRange,.flatpickr-day.endRange.inRange,.flatpickr-day.endRange.nextMonthDay,.flatpickr-day.endRange.prevMonthDay,.flatpickr-day.endRange:focus,.flatpickr-day.endRange:hover,.flatpickr-day.selected,.flatpickr-day.selected.inRange,.flatpickr-day.selected.nextMonthDay,.flatpickr-day.selected.prevMonthDay,.flatpickr-day.selected:focus,.flatpickr-day.selected:hover,.flatpickr-day.startRange,.flatpickr-day.startRange.inRange,.flatpickr-day.startRange.nextMonthDay,.flatpickr-day.startRange.prevMonthDay,.flatpickr-day.startRange:focus,.flatpickr-day.startRange:hover{background:#009640;box-shadow:none;color:#fff;border-color:#009640}.flatpickr-day.endRange.startRange,.flatpickr-day.selected.startRange,.flatpickr-day.startRange.startRange{border-radius:50px 0 0 50px}.flatpickr-day.endRange.endRange,.flatpickr-day.selected.endRange,.flatpickr-day.startRange.endRange{border-radius:0 50px 50px 0}.flatpickr-day.endRange.startRange+.endRange:not(:nth-child(7n+1)),.flatpickr-day.selected.startRange+.endRange:not(:nth-child(7n+1)),.flatpickr-day.startRange.startRange+.endRange:not(:nth-child(7n+1)){box-shadow:-10px 0 0 #009640}.flatpickr-day.endRange.startRange.endRange,.flatpickr-day.selected.startRange.endRange,.flatpickr-day.startRange.startRange.endRange{border-radius:50px}.flatpickr-day.inRange{border-radius:0;box-shadow:-5px 0 0 #d5d5d5,5px 0 0 #d5d5d5}.flatpickr-day.flatpickr-disabled,.flatpickr-day.flatpickr-disabled:hover,.flatpickr-day.nextMonthDay,.flatpickr-day.notAllowed,.flatpickr-day.notAllowed.nextMonthDay,.flatpickr-day.notAllowed.prevMonthDay,.flatpickr-day.prevMonthDay{color:rgba(88,88,88,.3);background:transparent;border-color:transparent;cursor:default}.flatpickr-day.flatpickr-disabled,.flatpickr-day.flatpickr-disabled:hover{cursor:not-allowed;color:rgba(88,88,88,.1)}.flatpickr-day.week.selected{border-radius:0;box-shadow:-5px 0 0 #009640,5px 0 0 #009640}.flatpickr-day.hidden{visibility:hidden}.rangeMode .flatpickr-day{margin-top:1px}.flatpickr-weekwrapper{float:left}.flatpickr-weekwrapper .flatpickr-weeks{padding:0 12px;border-left:1px solid rgba(88,88,88,.2)}.flatpickr-weekwrapper .flatpickr-weekday{float:none;width:100%;line-height:28px}.flatpickr-weekwrapper span.flatpickr-day,.flatpickr-weekwrapper span.flatpickr-day:hover{display:block;width:100%;max-width:none;color:rgba(88,88,88,.3);background:transparent;cursor:default;border:none}.flatpickr-innerContainer{display:block;display:flex;box-sizing:border-box;overflow:hidden;background:#fff;border-bottom:1px solid rgba(88,88,88,.2)}.flatpickr-rContainer{display:inline-block;padding:0;box-sizing:border-box}.flatpickr-time{text-align:center;outline:0;display:block;height:0;line-height:40px;max-height:40px;box-sizing:border-box;overflow:hidden;display:flex;background:#fff;border-radius:0 0 5px 5px}.flatpickr-time:after{content:\"\";display:table;clear:both}.flatpickr-time .numInputWrapper{flex:1;width:40%;height:40px;float:left}.flatpickr-time .numInputWrapper span.arrowUp:after{border-bottom-color:#585858}.flatpickr-time .numInputWrapper span.arrowDown:after{border-top-color:#585858}.flatpickr-time.hasSeconds .numInputWrapper{width:26%}.flatpickr-time.time24hr .numInputWrapper{width:49%}.flatpickr-time input{background:transparent;box-shadow:none;border:0;border-radius:0;text-align:center;margin:0;padding:0;height:inherit;line-height:inherit;color:#585858;font-size:14px;position:relative;box-sizing:border-box;-webkit-appearance:textfield;-moz-appearance:textfield;appearance:textfield}.flatpickr-time input.flatpickr-hour{font-weight:700}.flatpickr-time input.flatpickr-minute,.flatpickr-time input.flatpickr-second{font-weight:400}.flatpickr-time input:focus{outline:0;border:0}.flatpickr-time .flatpickr-am-pm,.flatpickr-time .flatpickr-time-separator{height:inherit;float:left;line-height:inherit;color:#585858;font-weight:700;width:2%;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;align-self:center}.flatpickr-time .flatpickr-am-pm{outline:0;width:18%;cursor:pointer;text-align:center;font-weight:400}.flatpickr-time .flatpickr-am-pm:focus,.flatpickr-time .flatpickr-am-pm:hover,.flatpickr-time input:focus,.flatpickr-time input:hover{background:#ddd}.flatpickr-input[readonly]{cursor:pointer}@keyframes fpFadeInDown{0%{opacity:0;transform:translate3d(0,-20px,0)}to{opacity:1;transform:translateZ(0)}}span.flatpickr-weekday{display:inline-block;width:14.2857143%}span.flatpickr-day{width:14.2857143%;margin:0 2.491071428571428px}@media screen and (min-width:0\\0){div.flatpickr-current-month{padding-top:0!important}}"

/***/ }),

/***/ "./webcomponents/va-datepicker/va-datepicker.ts":
/*!******************************************************!*\
  !*** ./webcomponents/va-datepicker/va-datepicker.ts ***!
  \******************************************************/
/*! exports provided: VaDatepicker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VaDatepicker", function() { return VaDatepicker; });
...
/* harmony import */ var _va_datepicker_styl__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./va-datepicker.styl */ "./webcomponents/va-datepicker/va-datepicker.styl");
/* harmony import */ var _va_datepicker_styl__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_va_datepicker_styl__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./va-datepicker.config */ "./webcomponents/va-datepicker/va-datepicker.config.ts");
...
/* harmony import */ var flatpickr_dist_l10n_de_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! flatpickr/dist/l10n/de.js */ "./node_modules/flatpickr/dist/l10n/de.js");
/* harmony import */ var flatpickr_dist_l10n_it_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! flatpickr/dist/l10n/it.js */ "./node_modules/flatpickr/dist/l10n/it.js");
/* harmony import */ var flatpickr_dist_l10n_fr_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! flatpickr/dist/l10n/fr.js */ "./node_modules/flatpickr/dist/l10n/fr.js");
...
var __decorate = undefined && undefined.__decorate || function (decorators, target, key, desc) {
  var c = arguments.length,
      ...
      d;
  if ((typeof Reflect === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_13___default()(Reflect)) === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) {
...
/*
* We import all the locales we use as part of the js for simplicity (no file copy, no path changes, etc.)
* English is default language built-in without locale file
* If we want to improve bundle size, we could also only import 1 locale related to the current page with html script tag
* However each locale file is ~1.3k (gzipped ~750) so it's not a significant optimization
*/
...
/**
 * The tagname of the current component
 */

var COMPONENT_NAME = 'va-datepicker';
var testYLE = {
...
window.test = testYLE;
/**
 * A custom datepicker webcomponent which embeed the flatpickr lib
 * to manage the datepicker part
 * @see https://flatpickr.js.org
 *
 * !! Even if possible, do not access the inner input from outside of
 * the component directly, but use the webcomponent provided accessors
 */

var VaDatepicker = VaDatepicker_1 = /*#__PURE__*/function (_LitElement) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_10___default()(VaDatepicker, _LitElement);

  var _super = _createSuper(VaDatepicker);

  /**
   * Create a Datepicker instance
   */
  function VaDatepicker() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_8___default()(this, VaDatepicker);

    _this = _super.call(this);
    /**
     * The Vaudoise configuration for the datepickr
     */

    _this.config = _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__["config"];

    if (!_this.id) {
      _this.id = Math.random().toString().substr(2);
    } // fetch language value from html[lang] attribute


    _this.config = _objectSpread(_objectSpread({}, _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__["config"]), {}, {
      locale: flatpickr__WEBPACK_IMPORTED_MODULE_18__["default"].l10ns[_this.getDatePickerLocaleFromPage()]
    });
    return _this;
  }
  /**
   * The date field
   * @returns the date input element from the template
   */


  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_9___default()(VaDatepicker, [{
    key: "dateInput",
    get: function get() {
      return this.firstElementChild;
    }
    /**
     * The datepicker can be configured to select a range
     * This accessor will return all selected values
    ...
    key: "selectedValues",
    get: function get() {
      return this.pickerInstance.selectedDates;
    }
    /**
     * Gets the selected value with the format chosen for code logic
    ...
    get: function get() {
      ...
      return this.pickerInstance.formatDate(selectedValues[0], _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__["config"].dateFormat);
    }
    /**
     * Sets the selected value with the format chosen for code logic
     * @param val - the date to select
     */
    ,
    set: function set(val) {
      this.pickerInstance.setDate(val, true, _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__["config"].dateFormat);
    }
    /**
     * Gets the selected value formatted like displayed to the user
     * @returns the selected date
     */
    ...
    get: function get() {
      ...
      return this.pickerInstance.formatDate(selectedValues[0], _va_datepicker_config__WEBPACK_IMPORTED_MODULE_19__["config"].altFormat);
    }
    /**
     * Gets the locale define at html[lang] level and return a flatpickr valid locale
     * @returns the locale to be used by the datepicker
     */

  }, {
    key: "getDatePickerLocaleFromPage",
    value: function getDatePickerLocaleFromPage() {
      var localeName = 'default';
      var lang = document.documentElement.lang.substr(0, 2);

      if (flatpickr__WEBPACK_IMPORTED_MODULE_18__["default"].l10ns[lang]) {
        localeName = lang;
      }
    ...
    value: function firstUpdated() {
      this.pickerInstance = Object(flatpickr__WEBPACK_IMPORTED_MODULE_18__["default"])(this.dateInput, this.config);
    }
    /**
     * This prevent the use of the shadowDom by returning
     * directly the instance instead of a shadow root
    ...
    key: "render",
    value: function render() {
      return Object(lit_element__WEBPACK_IMPORTED_MODULE_20__["html"])(_templateObject || (_templateObject = _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_6___default()(["\n            <input type=\"text\" id=\"dp-", "\" class=\"va-datepicker-input form-control\" />\n            <style class=\"d-none\">", "</style>\n        "])), this.id, VaDatepicker_1.styles);
    }
    /**
     * Css styles
    ...
    key: "styles",
    get: function get() {
      return [Object(lit_element__WEBPACK_IMPORTED_MODULE_20__["css"])(_templateObject2 || (_templateObject2 = _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_6___default()(["", ""])), Object(lit_element__WEBPACK_IMPORTED_MODULE_20__["unsafeCSS"])(_va_datepicker_styl__WEBPACK_IMPORTED_MODULE_17___default.a))];
    }
  }]);
...
VaDatepicker = VaDatepicker_1 = __decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_20__["customElement"])(COMPONENT_NAME)], VaDatepicker);
...
/***/ 1:
/*!************************************************************!*\
  !*** multi ./webcomponents/va-datepicker/va-datepicker.ts ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\devs\va.cms\Source\01 Modules\Va.Cms.Sitefinity\ResourcePackages\Vaudoise\assets\src\webcomponents\va-datepicker\va-datepicker.ts */"./webcomponents/va-datepicker/va-datepicker.ts");
